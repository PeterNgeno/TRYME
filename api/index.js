...
const generateAccessToken = async (req, res, next) => {
  ...
  await axios
    .get(
      "https://api.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials", // Production URL
      {
        headers: {
...
app.post("/pay", generateAccessToken, async (req, res) => {
  ...
  try {
    ...
    const stkResponse = await axios.post(
      "https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest", // Production URL
      {
        ...
        AccountReference: "PERON TIPS LTD", // Update the AccountReference
